...
namespace NativeToolStrip {
    public enum NativeToolStripTheme {
        Toolbar,
        MediaToolbar,
    ...
    public class NativeToolStripRenderer : ToolStripSystemRenderer {
        ...
        public NativeToolStripRenderer(NativeToolStripTheme theme) {
            Theme = theme;
        }
        ...
        private string SubclassPrefix {
            get {
                switch (Theme) {
                    case NativeToolStripTheme.MediaToolbar: return "Media::";
                    case NativeToolStripTheme.CommunicationsToolbar: return "Communications::";
                    case NativeToolStripTheme.BrowserTabBar: return "BrowserTabBar::";
                    case NativeToolStripTheme.HelpBar: return "Help::";
        ...
        protected override void Initialize(ToolStrip toolStrip) {
            if (toolStrip.Parent is ToolStripPanel || Theme == NativeToolStripTheme.Transparent)
        ...
        protected override void OnRenderToolStripBackground(System.Windows.Forms.ToolStripRenderEventArgs e) {
            if (EnsureRenderer()) {
                if (e.ToolStrip.IsDropDown) {
                    ...
                    if (e.ToolStrip.Parent is ToolStripPanel || Theme == NativeToolStripTheme.Transparent) {
        ...
        protected override void OnRenderOverflowButtonBackground(ToolStripItemRenderEventArgs e) {
            if (EnsureRenderer()) {
                ...
                if (Theme == NativeToolStripTheme.BrowserTabBar)
                    rebarClass = "Rebar";
