...
namespace YouTube
{
    static class DataApi
    {
        ...
        public static string SearchFeedUrl(string queryText)
        {
            ...
            return GetFullUrl("feeds/api/videos?q=" + query);
        }

        public static string StandardFeedUrl(string feedName)
        {
            return GetFullUrl("feeds/api/standardfeeds/" + feedName);
        }

        public static Feed GetSearchResults(string queryText)
        {
            return GetFeed(SearchFeedUrl(queryText));
        }

        public static Feed GetRelatedVideos(string videoId)
        {
            var url = GetFullUrl("feeds/api/videos/" + videoId + "/related");

            return GetFeed(url);
        }

        public static Entry GetVideo(string videoId)
        {
